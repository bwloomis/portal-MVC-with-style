...
(function( $ ){
	jQuery.sessionTimeout = function( options ) {
	    ...
	    // Hold milliseconds remaining
		var remaining = o.warnAfter;

		setupMinutesRemainingDisplay(remaining);
		...
		var interval;
		function setupMinutesRemainingDisplay() {
		    remaining = o.redirAfter;
		    clearInterval(interval);
		    var minutesRemaining = Math.ceil(remaining/60000);
		    $("#minutesRemaining").val(minutesRemaining);
		    interval = setInterval(function () {
		        subtractAndDisplayMinutesRemaining();
		    }, 60000);

		}

		function subtractAndDisplayMinutesRemaining() {
