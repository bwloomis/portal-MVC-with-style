...
!function( $ ) {
  ...
  * ================================ */
  ...
  var Combobox = function ( element, options ) {
      ...
      this.templateSelector = this.options.templateSelector
    ...
    this.listen();
    this.makeSavedValueSelected();
  };

  Combobox.prototype = {

      constructor: Combobox
  , makeSavedValueSelected: function () {

      if (this.$element.val() != "") {
          $(this.$element).prop("disabled", "disabled");
          //addition to make element readonly after selection
  ...
  , setup: function () {
      var combobox = $(this.templateSelector);
  ...
  , toggle: function () {
    ...
    {
        //remove disabled attr if exists
